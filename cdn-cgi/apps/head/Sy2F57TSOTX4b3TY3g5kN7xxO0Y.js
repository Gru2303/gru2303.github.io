;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="bbc1cf01e7c1cc46049e643111bc13e4";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["f04mwyiwboth"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["f04mwyiwboth"].options={"account":{"accountId":"DcByRs43Fy53","service":"googleanalytics","userId":"109468503378561573567"},"anonymizeIp":false,"id":"","organization":"113645365","social":false,"web-properties-for-113645365":"UA-113645365-1","webPropertySchemaNames":["web-properties-for-113645365"]};;if(CloudflareApps.matchPage(CloudflareApps.installs['f04mwyiwboth'].URLPatterns)){(function(){var options=CloudflareApps.installs['f04mwyiwboth'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("f04mwyiwboth"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
